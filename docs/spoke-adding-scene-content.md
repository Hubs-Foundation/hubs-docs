...
![Hubs Image](img/spoke-3d-model.png)
...
![object spawner](img/spoke-spawner.png)
...
![Hubs Image](img/spoke-images.png)
...
![Hubs Image](img/spoke-particle-emitter.png)

## Links
Link to different models
either to different hubs rooms or to different 
