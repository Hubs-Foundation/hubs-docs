...
![Spoke Templates](img/spoke-template.jpeg)
 ...
 From here you can customize your scene entirely to your liking! Try [adding content](./spoke-adding-scene-content.mdx) to your scene, or building a house with our [architecture kit](./spoke-architecture-kit.mdx).
...
2. In the menu, select **File > Import legacy .spoke project**
3. Select **Ok** in the prompt (be careful of overwriting something you want to keep) and then select the desired file to upload.
