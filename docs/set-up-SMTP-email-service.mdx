...
<a id="part-1-step-8"></a>8\. To use SMTP services from Scaleway, you must validate a payment method. Scaleway only has a pay by credit card option. For Add your payment method, enter your credit card number, expiration date, CVV or CVC, Name on card, and select **Add payment method.**
...
<a id="part-4-step-27"></a>27\. For Create an Application, **Enter a name** and optional description.
