...
<img src="img/audio-zones-example-2.jpg" alt="drawing of InOut zone with gain: 0.0" width="500" style="display: block; margin-left: auto; margin-right: auto;"/>

<p style="text-align: center; font-style: italic;">InOut zone that blocks all the audio sources coming from the inside.</p>

<img src="img/audio-zones-example-3.jpg" alt="drawing of OutIn zone with gain: 0.0" width="500" style="display: block; margin-left: auto; margin-right: auto;"/>

<p style="text-align: center; font-style: italic;">OutIn zone that blocks all the audio sources coming from the outside.</p>
...
<img src="img/audio-zones-example-1.jpg" alt="drawing of nested audio zones" width="500" style="display: block; margin-left: auto; margin-right: auto;"/>

<p style="text-align: center; font-style: italic;">If there are two audio-zones in between the listener and the source and the first one has gain == 0.1 and the other has gain == 0.5, gain == 0.1 is applied to the source.</p>
