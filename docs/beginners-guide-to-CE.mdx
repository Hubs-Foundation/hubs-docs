...
Check our [FAQs](./faq.mdx). Also, our community [Discord](https://discord.gg/hubs-498741086295031808) is standing by.
...
> 🤔 Advice: VS Code allows the installation of extensions to provide additional functionality.  If you install any of these, we recommend that you disable automatic updates for extensions as a security measure.\
> In VS Code:\
> 1\. Select the Extensions tab\
> 2\. Select the 3 dot button\
> 3\. Select Disable Auto Update for All Extensions
>
> ![Capture of VS Code, Extensions tab, "Disable Auto Update for All Extensions" is highlighted.](img/beginnersguide/vs-code-disable-extensions-auto-update.png)
...
> 🤔 Advice: See our FAQ [Can I select a lower price, smaller RAM/vCPU Node plan with DigitalOcean?](./faq.mdx#can-i-select-a-lower-price-smaller-ramvcpu-node-plan-with-digitalocean) for our further advice about selecting node and memory plans.
...
1. Follow [these instructions](./set-up-SMTP-email-service.mdx) for Parts 1–4.
...
c. Refer to our [FAQs](./faq.mdx) for advice on making sure that your kubectl version aligns with your kubernetes version at DO.
...
Follow [instructions 1 through 10 here](./download-and-install-doctl.mdx).
...
g. **Copy and save** your Token somewhere securely. If you ever change computers to control your Hubs, you’ll either need this Token or you’ll need to [generate a new Token](./faq.mdx#can-i-change-my-token-from-do-if-my-token-has-been-compromised).
...
> 💡 Tip: Further errors? See our [FAQs](./faq.mdx) or ask for help in Discord.
...
> 🤔 Note: Your SSL certificates expire **every 90 days**. Don’t worry. We’ve [got instructions for you when that happens](./regenerating-ssl-certificates.mdx).
...
* Visit [**What's next?**](./whats-next.mdx) for tips on room settings, importing scenes, and backups.
