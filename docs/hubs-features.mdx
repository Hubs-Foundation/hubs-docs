...
1. __Invite:__ Opens a dialog box with information on sharing the room with friends. More info is provided in the [Invite Menu](#invite-menu) section at the bottom of this page.
