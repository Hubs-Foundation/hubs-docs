...
d. Password -> SMTP_PASS: paste in the **Secret Key** you saved from Step 7 Set up SMTP email, Part 4, Step 15.💡Tip: Make sure you are using your Scaleway Username and Secret Key, not your Access Key ID.
