...
[Learn more about the Discord bot here](./hubs-discord-bot.mdx)

[Enable the Discord bot for your Community Edition instance](./hubs-cloud-discord-bot.mdx)

## Room Access Settings

Individual rooms can also limit access via [Room Access Settings](./hubs-room-settings.mdx#room-access).
